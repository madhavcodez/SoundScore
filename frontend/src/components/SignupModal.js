...
function SignupModal({ spotifyData, onComplete }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!username || !password || !spotifyData?.id) {
        ...
        <div className="relative p-8 rounded-2xl bg-gradient-to-br from-gray-800/50 to-gray-900/50 
          ...
          <div className="relative z-10">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label className="block text-[#8BA888] mb-2 text-sm font-medium">Password</label>
                <input
                  type="password"
                  value={password}
              ...
              <div>
                <label className="block text-[#8BA888] mb-2 text-sm font-medium">Confirm Password</label>
                <input
                  type="password"
